...
class _QuotationsPageState extends State<QuotationsPage> {
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  IconButton(
                    icon: Icon(Icons.close, size: 16, color: Colors.indigo.shade400),
                    onPressed: () {
                      context.read<QuotationProvider>().cargarCotizaciones();
                    },
            ...
            child: ListView(
              ...
              children: _estados.map((estado) {
                ...
                return Padding(
                  ...
                  child: FilterChip(
                    label: Text(
                      estado == 'Todas' ? 'Todas' : estado[0].toUpperCase() + estado.substring(1),
                      style: TextStyle(
                        fontSize: 12,
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  IconButton(
                    onPressed: () => context.read<QuotationProvider>().limpiarError(),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              sinCotizaciones
                  ? 'Selecciona un bot y crea tu primera cotización.'
  ...
  void _crearCotizacion(BuildContext context, String botId, String botNombre) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => BotQuotationFormPage(botId: botId, botNombre: botNombre),
      ),
    );
  }

  void _abrirDetalle(BuildContext context, BotQuotationModel cotizacion) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => BotQuotationDetailPage(
          botId: cotizacion.botId ?? '',
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  cotizacion.titulo ?? 'Cotización de servicios',
