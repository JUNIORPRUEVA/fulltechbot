...
class _GridProductCardState extends State<_GridProductCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final primaryImage = StorefrontHelpers.getPrimaryImage(widget.product);
                      ...
                      ClipRRect(
                        ...
                        child: DecoratedBox(
                          ...
                          child: _ProductCardImage(
                            ...
                            width: widget.isDesktop ? 320 : 220,
                            height: widget.isDesktop ? 260 : 180,
                          ),
                        ),
                      ),
                      Positioned(
...
class _ListProductCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final primaryImage = StorefrontHelpers.getPrimaryImage(product);
