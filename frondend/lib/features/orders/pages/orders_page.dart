...
class _OrdersPageState extends State<OrdersPage> {
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  IconButton(
                    icon: Icon(Icons.close, size: 16, color: Colors.blue.shade400),
                    onPressed: () {
                      context.read<OrderProvider>().cargarOrdenes();
                    },
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  IconButton(
                    onPressed: () => context.read<OrderProvider>().limpiarError(),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              sinOrdenes ? 'No hay pedidos registrados' : 'Sin resultados',
              style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w700),
            ),
            const SizedBox(height: 8),
            Text(
              sinOrdenes
                  ? 'Selecciona un bot y crea tu primer pedido.'
  ...
  void _abrirDetalle(BuildContext context, BotOrderModel orden) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => BotOrderDetailPage(botId: orden.botId ?? '', orden: orden),
      ),
    );
  }
}
